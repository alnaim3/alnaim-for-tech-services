...
<a href="index.html"><button type="button" class="btn btn-outline-primary">الرئيسية</a></button>
  ...
  <div class="form-group">
    <label for="exampleFormControlInput1">صاحب الحساب</label>
    <input type="text"  name="number"class="form-control" id="exampleFormControlInput1" placeholder="صاحب الحساب">
  </div>
           
           <div class="form-group">
    <label for="exampleFormControlInput1">رقم الهاتف</label>
    <input type="text"  name="number"class="form-control" id="exampleFormControlInput1" placeholder="رقم الحساب">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">رقم العداد</label>
    <input type="text"  name="number"class="form-control" id="exampleFormControlInput1" placeholder="رقم الحساب">
  </div>
  ...
  <div class="form-group">
    ...
    <input  type="text" name="sum" class="form-control" id="exampleFormControlInput1" placeholder="المبلغ">
            ...
            <div class="form-group">
    <button type="submit" class="btn btn-primary">اشراء</button>
  </div>
</form>
    </div>
