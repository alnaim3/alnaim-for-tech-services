...
<a href="index.html"><button type="button" class="btn btn-outline-primary">الرئيسية</a></button>
  ...
  <div class="form-group">
    <label for="exampleFormControlInput1">رقم الحساب</label>
    <input type="text"  name="number"class="form-control" id="exampleFormControlInput1" placeholder="رقم الحساب">
  </div>
  <div class="form-group">
      <label for="exampleFormControlSelect1" id="">اسم البنك</label>
    <select name="type"class="form-control" id="exampleFormControlSelect1">
      <option>بنك الخرطوم</option>
      <option>بنك فيصل</option>
